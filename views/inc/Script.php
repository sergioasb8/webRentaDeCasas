<!-- jQuery V3.4.1 -->
<script src="<?php echo SERVERURL; ?>views/js/jquery-3.4.1.min.js" ></script>
...
<script src="<?php echo SERVERURL; ?>views/js/bootstrap-material-design.min.js" ></script>
...
<script src="<?php echo SERVERURL; ?>views/js/mdb.min.js" ></script>